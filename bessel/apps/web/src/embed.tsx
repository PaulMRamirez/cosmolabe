...
// only a host's bundler can know (via the shared fixture compute adapter)
// and asking fallback compute for all four M-0004 product kinds against the
// GS-2 era boot kernels. No workbench chrome, no store, no scene: if this
// page renders products, the panel is embeddable.

import { mount, type HostDataAdapter } from '@bessel/panel';
import { fixtureComputeAdapter } from './fixture-compute.ts';

const HOUR = 3600;

const data: HostDataAdapter = {
  compute: fixtureComputeAdapter([
    {
